...
public class ControllerBanHang {
    ...
    public void setViewAndEvent() {
        ...
        tableSP.getTableHeader().setPreferredSize(new Dimension(60, 50));
        ...
        scrollSP.setPreferredSize(new Dimension(800, 300));
        pnTableSP.removeAll();
        ...
        tableCTHD.getTableHeader().setPreferredSize(new Dimension(60, 30));
...
//		tableCTHD.getViewport().add(tableCTHD);
        tableCTHD.setPreferredSize(new Dimension(800, 150));
